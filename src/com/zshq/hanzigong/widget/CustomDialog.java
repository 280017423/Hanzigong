...
public class CustomDialog extends Dialog {
	...
	public static class Builder {
		...
		private int mMessageTextColor_1;
		private int mMessageTextSize_1;
		 ...
		 * @return Builder对象
		 */
		public Builder setMessage_1(String message) {
			this.mMessage_1 = message;
			return this;
		}
		 ...
		 * @return Builder对象
		 */
		public Builder setMessage_1(int message) {
			this.mMessage_1 = (String) mContext.getText(message);
			return this;
		}
		...
		public int getmMessageTextColor_1() {
			return mMessageTextColor_1;
		}

		public void setmMessageTextColor_1(int mMessageTextColor_1) {
			this.mMessageTextColor_1 = mMessageTextColor_1;
		}

		public int getmMessageTextSize_1() {
			return mMessageTextSize_1;
		}

		public void setmMessageTextSize_1(int mMessageTextSize_1) {
			this.mMessageTextSize_1 = mMessageTextSize_1;
		}
		...
		/**
		 * 
		 * @Method: setmDialogView
		 * @Description: 增加自定义view
		 * @param @param mDialogView
		 * @return void
		 * @throws
		 */
		public void setmDialogView(View mDialogView) {
		...
		public CustomDialog create(int id) {
			...
			setDialogMessage_1(tvMessage_1);
		 ...
		 *            对话框Message对象
		 */
		private void setDialogMessage_1(TextView tvMessage) {
			if (0 != mMessageTextSize_1) {
				tvMessage.setTextSize(mMessageTextSize_1);
			}
			if (0 != mMessageTextColor_1) {
				tvMessage.setTextColor(mMessageTextColor_1);
			}
			if (!StringUtil.isNullOrEmpty(mMessage_1)) {
				tvMessage.setText(mMessage_1); // 设置消息内容
			} else {
				tvMessage.setVisibility(View.GONE);
			}
		}
